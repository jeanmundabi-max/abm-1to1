...
| Axis | This build |
|---|---|
| The world drawn | A wall of screens. The ground of the first drawn figure is the retail floor Currys actually has, and the measurement is taken across it. The second figure puts the Nordics figures on three rules. |
| The filed evidence | A different sentence from a different document, quoted whole |
| The inversion | Hays did not hedge, and the Hays page says in as many words that the hedging story is not theirs. Currys did hedge, and their own sentence names the devaluation of forward purchase contracts as the cause. So the third paragraph of act 2b says the opposite on this page: the version of this argument that is not yours is the one about failing to cover. |
| The named seat | Bruce Marsh, Group Chief Financial Officer, on the Board since July 2021, from Companies House 07105905 and the Currys board page. The Group Treasurer seat is not public and is left unnamed rather than inferred. |

### The figures, and where they come from

`currys_bridge` and `currys_nordics` in `build_deep.py`. Both are drawn from figures in the full year results for 2025/26, published 2 July 2026. Bar length in the second is drawn to sit on the page and the figure says so on itself.
