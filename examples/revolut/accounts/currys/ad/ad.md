...
![The ad card for Currys plc](card.png)
...
> The hedge is one line. The conversions are another.

Every conversion Currys made last month, set beside the interbank rate for the same day and the
...
| | |
|---|---|
| Company | Currys plc, Electrical retail |
| Function | Accounting, Finance, Operations, Programme and project management |
| Excluded | Unpaid, Training, Entry level |
| Country | United Kingdom |
| People it can reach | **1,200** |

## Finding this company on LinkedIn nearly failed

The shared lever narrowed Currys to **0**, while the company unnarrowed returned 9,100. A zero after a filter is not the same as a small company.
