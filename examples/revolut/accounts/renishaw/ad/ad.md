...
![The ad card for Renishaw plc](card.png)
...
> Measured to the micron. Priced on the spread.

Every conversion Renishaw made last month, set beside the interbank rate for the same day and
the same amount. The gap comes back in basis points and in pounds, one number per currency,
with the workings attached.
