# The ad: UK Health Security Agency

![The ad card for UK Health Security Agency](card.png)
...
> You published the award notice yourself, so anyone can read it. UKHSA has 21 software contracts running. The first to expire does so in 222 days, and a renewal is the only moment the price is negotiable. A free contract review says whether the number is the right number, and costs nothing if it is.

**Headline**

> UKHSA: 21 software contracts, the first ends in 222 days

**Button** `Learn More`

**Where it went** `https://jeanmundabi-max.github.io/mdb-abm-gocardless/w/ukhsa/` · **this address no longer resolves.** The page itself
...
| | |
|---|---|
| Organisation | UK Health Security Agency, and no other |
| Function | Finance, technology, operations and programme |
| Excluded | Unpaid, Training, Entry level |
| Country | United Kingdom |
| People it can reach | **910**, measured on LinkedIn on 21 August 2026 |

Ad set `WYN - ...  - UK Health Security Agency`, id `AD_SET_ID`, status **DRAFT**. Nothing was activated and
nothing was spent.
