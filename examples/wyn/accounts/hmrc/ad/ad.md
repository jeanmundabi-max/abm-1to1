# The ad: HM Revenue & Customs

![The ad card for HM Revenue & Customs](card.png)
...
> You published the award notice yourself, so anyone can read it. HMRC has 16 software contracts running. The first to expire does so in 101 days, and a renewal is the only moment the price is negotiable. A free contract review says whether the number is the right number, and costs nothing if it is.

**Headline**

> HMRC: 16 software contracts, the first ends in 101 days

**Button** `Learn More`

**Where it went** `https://jeanmundabi-max.github.io/mdb-abm-gocardless/w/hmrc/` · **this address no longer resolves.** The page itself
...
| | |
|---|---|
| Organisation | HM Revenue & Customs, and no other |
| Function | Accounting, Finance |
| Excluded | Unpaid, Training, Entry level |
| Country | United Kingdom |
| People it can reach | **3,300**, measured on LinkedIn on 21 August 2026 |

Ad set `WYN - ...  - HM Revenue & Customs`, id `AD_SET_ID`, status **DRAFT**. Nothing was activated and
nothing was spent.
