# SCORE — WYN × the Ministry of Housing, Communities and Local Government
...
Two rails of identical stroke weight and identical type size carry Ministry of Housing, Communities and Local Government at £4,500,000 and Essex County Council at £4,206,817.
...
|---|---|---|---|---|---|
| 1 | Both names | Held film + drawn SVG | Recognition | 2.4 | The film is the card in motion, so the click resolves the still into travel |
| 2 | The one that is checkable | Kinetic figures on a rule | Unease | 1.8 | Numbers arriving on a line, not in boxes |
| 3 | The hinge | Flow, authored silence | Understanding | 1.2 | One sentence on white. No figure, no accent, nothing asked |
| 4 | Beside a county council | **Pointer.** The held verdict | The peak | 3.0 | The largest span. An argument they perform rather than read |
...
- **The only accent in thirty seconds** lands at 24s on 12 April 2027 and on nothing else.
