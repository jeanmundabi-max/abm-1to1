...
![The ad card for Home Office](card.png)
...
> You published the award notice yourself, so anyone can read it. the Home Office has 25 software contracts running. The first to expire does so in 101 days, and a renewal is the only moment the price is negotiable. A free contract review says whether the number is the right number, and costs nothing if it is.

**Headline**

> the Home Office: 25 software contracts, the first ends in 101 days

**Button** `Learn More`

**Where it went** `https://jeanmundabi-max.github.io/mdb-abm-gocardless/w/home-office/` · **this address no longer resolves.** The page itself
...
| | |
|---|---|
| Organisation | Home Office, and no other |
| Function | Accounting, Finance |
| Excluded | Unpaid, Training, Entry level |
| Country | United Kingdom |
| People it can reach | **560**, measured on LinkedIn on 21 August 2026 |

Ad set `WYN - ...  - Home Office`, id `AD_SET_ID`, status **DRAFT**. Nothing was activated and
nothing was spent.
