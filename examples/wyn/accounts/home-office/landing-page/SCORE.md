...
Two rails of identical stroke weight and identical type size carry Home Office at £150,196,594 and HM Revenue & Customs at £116,746,575.
...
| 2 | The two at the top | Kinetic figures on a rule | Unease | 1.8 | Numbers arriving on a line, not in boxes |
| 3 | The hinge | Flow, authored silence | Understanding | 1.2 | One sentence on white. No figure, no accent, nothing asked |
| 4 | The same day | **Pointer.** The held verdict | The peak | 3.0 | The largest span. An argument they perform rather than read |
...
- **The only accent in thirty seconds** lands at 24s on 30 November 2026 and on nothing else.
